...
if( lib.event.nativeEvents[ 'mouseenter'].supported)
  return;
...
with( MouseEnterEvent =function(){}) {
  ...
  // handle mouse over
  prototype.handleMouseOver =function( e) {
    ...
    lib.event.trigger( e.currentTarget, 'mouseenter');
  };
  ...
  prototype.attach =function( elem) {
    ...
    lib.event.bind( elem, 'mouseover', this.handleMouseOver);
  };
  ...
  prototype.detach =function( elem) {
    ...
    lib.event.unbind( elem, 'mouseover', this.handleMouseOver);
